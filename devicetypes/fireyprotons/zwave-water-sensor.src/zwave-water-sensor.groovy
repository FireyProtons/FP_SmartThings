 ...
 *  Date: 2013-11-3
 */
//modified code to turn a Monoprice z-wave door/window sensor into a sensor for a float switch in the sump pit.

metadata {
	definition (name: "Z-Wave Water Sensor", namespace: "FireyProtons", author: "FireyProtons") {
...
private configSetCmd(paramNumber, valSize, val) {	
	log.trace "Setting configuration param #${paramNumber} to ${val}"
...
private configGetCmd(paramNumber) {
	log.trace "Requesting configuration report for param #${paramNumber}"
